...
# Shubo Lin, Ouyang Xu, Zhenpeng Shi, Mengqi Xu
...
# ############################ File Write###########################################
write.xlsx(x = cbind(result,equal_variance), file = "04-30-11-20USA_coeffcient_without0.xlsx")
